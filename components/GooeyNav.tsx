...
const GooeyNav = ({
  ...
  const currentActiveIndex = items.findIndex(item => item.href === pathname);
  const [activeIndex, setActiveIndex] = useState(currentActiveIndex >= 0 ? currentActiveIndex : initialActiveIndex);
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>, index: number) => {
    ...
    // Navigate to href using Next.js router
