...
export const services: Service[] = [
  { name: '24/7 Магазин',  description: 'Непрекъснато работещ магазин с всичко необходимо. С карта BG OIL имате 10 % отстъпка при закупуване стоки от магазина на бензиностанциятас!', icon: '🏪' },
