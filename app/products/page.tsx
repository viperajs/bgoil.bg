            ...
            <div className="mt-8 p-4 bg-accent/10 border border-accent/20 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-accent-foreground">Важна информация за цените</p>
                  <p className="text-sm text-accent-foreground/80">
                    Цените са ориентировъчни и могат да се променят без предварително уведомление. Моля, потвърдете
                    актуалните цени на място при персонала на бензиностанцията.
                  </p>
                </div>
              </div>
            </div>
