...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "хотел 24/7 Враца",
    "BG OIL хотел резервация",
    "стаи за настаняване Враца",
    "апартаменти за настаняване",
    "хотел близо до бензиностанция",
    "комфортни стаи Враца",
    "луксозни апартаменти Враца",
    "хотел с WiFi Враца",
    "24/7 рецепция Враца",
  ],
  openGraph: {
    title: `Хотел ${companyInfo.name} - Комфортни стаи и апартаменти във Враца`,
    description: "Комфортни стаи и апартаменти в хотела на BG OIL. WiFi, паркинг, 24/7 рецепция. Резервации: 0889 15 55 12.",
